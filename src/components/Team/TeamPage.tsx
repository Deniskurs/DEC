...
const EXECUTIVE_TEAM: ExecutiveMember[] = [
  {
    ...
    philosophy:
      "Building sustainable investment strategies through disciplined risk management and institutional excellence.",
  ...
  },
  {
    ...
    philosophy:
      "Systematic approaches to market inefficiencies create sustainable competitive advantages in quantitative investing.",
  ...
  },
  {
    ...
    philosophy:
      "Technology infrastructure is the foundation upon which successful quantitative strategies are built and scaled.",
  ...
  },
  {
    ...
    philosophy:
      "Exceptional client service is built on transparency, clear communication, and unwavering commitment to fiduciary duty.",
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-32">
          ...
          >
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-slate-400 leading-relaxed font-light px-4 sm:px-0">
                Our leadership team brings together decades of institutional
                finance experience, united by a shared commitment to
                quantitative excellence and fiduciary responsibility.
              </p>
            </div>
          </motion.header>
          ...
          >
            {EXECUTIVE_TEAM.map((member, index) => (
              <ExecutiveProfile key={member.id} member={member} index={index} />
            ))}
          </motion.section>
        </div>
      </div>
