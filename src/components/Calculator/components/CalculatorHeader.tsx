      ...
      >
        ...
        >
          <p className="text-xl sm:text-2xl text-rich-blue-600/90 leading-relaxed font-light">
            While the elite compound their wealth through sophisticated
            algorithms,
            <motion.span
              className="font-semibold text-red-500 inline-block ml-2"
              animate={{
                opacity: [1, 0.7, 1],
              }}
              transition={{
            ...
            >
              your capital remains stagnant
            </motion.span>
          </p>

          <p className="text-lg text-rich-blue-600/80">
            Calculate your opportunity cost and see what you're missing in
            real-time.
          </p>
