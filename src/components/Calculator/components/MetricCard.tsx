...
const MetricCard: React.FC<MetricCardProps> = ({
  ...
  const baseClasses =
    "relative p-8 rounded-xl overflow-hidden group transition-all duration-500 ease-out transform hover:-translate-y-1 hover:shadow-lg";
      ...
      >
        ...
        <div className="relative h-full flex items-center justify-between">
          <div className="flex items-center space-x-6">
            ...
            <div>
              <div
                className={`text-sm font-medium ${labelColor} mb-2 uppercase tracking-wider`}
              >
                {label}
              </div>
              ...
              <div
                className={`text-sm ${descriptionColor} transition-all duration-300 group-hover:opacity-90`}
              >
                {description}
              </div>
            </div>
