              ...
              >
                ...
                <div className="relative p-3 flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="text-cream-50/70 hover:text-cream-50 transition-colors duration-200"
        ...
        >
          <div className="max-w-3xl mx-auto pointer-events-auto">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-rich-blue-900 via-rich-blue-800 to-rich-blue-900" />
              ...
              <div className="relative flex items-center justify-between p-4">
                  ...
                  {!isSmallMobile && (
                    <div>
                      ...
                      <p className="text-sm text-cream-50/80 mt-1 max-w-xl">
                        Our algorithms consistently outperform traditional
                        options
                      </p>
                    </div>
                  )}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    onClick={() => setDismissed(true)}
                    className="text-cream-50/70 hover:text-cream-50 transition-colors duration-200 p-1 rounded-full hover:bg-rich-blue-700/30"
                    aria-label="Dismiss banner"
                  >
