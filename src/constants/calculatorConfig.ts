...
export const getChartData = (
  ...
  const msciMonthlyRate = msciMonthlyReturn
    ? msciMonthlyReturn / 100
    : TRADITIONAL_APY / 12;
  return {
    ...
    datasets: [
      {
        ...
        data: Array.from({ length: months + 1 }, (_, i) => {
          return investment * Math.pow(1 + monthlyRate, i);
        }),
      ...
      },
      {
        label: "MSCI ETF",
        data: Array.from({ length: months + 1 }, (_, i) => {
          return investment * (1 + msciMonthlyRate * i);
        }),
